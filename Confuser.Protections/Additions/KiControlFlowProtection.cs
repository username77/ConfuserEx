...
namespace Confuser.Protections.Additions {
	internal class KiControlFlowProtection : Protection {
		public const string _Id = "ki ctrl flow";
		public const string _FullId = "Ki.ControlFlow2";

		public override string Name => "Ki Control Flow Protection";
		public override string Description => "This protection mangles code with integer-based control flow obfuscation.";
		...
		protected override void PopulatePipeline(ProtectionPipeline pipeline) {
			pipeline.InsertPreStage(PipelineStage.OptimizeMethods, new KiControlFlowPhase(this));
		}

		class KiControlFlowPhase : ProtectionPhase {
			public KiControlFlowPhase(KiControlFlowProtection parent) : base(parent) { }

			public override ProtectionTargets Targets => ProtectionTargets.Methods;
			public override string Name => "Ki control flow";
